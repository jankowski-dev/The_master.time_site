(function () {
  ...
  function resetState() {
    ...
    var nextBtn = $('#next-services'); if (nextBtn) nextBtn.disabled = true;
  ...
  function simulateUpload(fillEl, statusEl, count) {
